...
export default function Footer() {
  return (
    <footer className="relative mt-24 md:mt-32">
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-[76px] bg-gradient-peach-veil opacity-70 dark:opacity-40 pointer-events-none"
      />
      ...
      <Container className="relative pt-24 md:pt-28 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-x-8 gap-y-12">
          <div className="col-span-2 md:col-span-2 flex flex-col gap-6">
            ...
            <div className="mt-2">
              <Eyebrow className="mb-3 text-fg-subtle">Closed beta</Eyebrow>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((s) => (
                <a
                  ...
                  className="text-fg-muted hover:text-fg-strong transition-colors duration-200 ease-soft"
                >
            ...
            <ul className="flex items-center gap-5">
              {legalLinks.map((l) => (
                <li key={l.href}>
                  <NextLink
                    href={l.href}
                    className="text-[13px] text-fg-muted hover:text-fg-strong transition-colors duration-200 ease-soft"
                  >
                    {l.label}
                  </NextLink>
                </li>
...
function FooterColumn({
  ...
  return (
    <div className="flex flex-col gap-3">
      <Eyebrow className="text-fg-subtle mb-1">{heading}</Eyebrow>
  ...
  return (
    <li>
      <NextLink
        ...
        className="text-[15px] text-fg-muted hover:text-fg-strong transition-colors duration-200 ease-soft"
      >
        {children}
      </NextLink>
    </li>
